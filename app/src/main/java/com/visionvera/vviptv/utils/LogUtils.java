 ...
 */
package com.visionvera.vviptv.utils;
...
public class LogUtils {
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + HealthApplication.getsInstance().getPackageName();
        LOG_FILE_NAME = "Log";
    }
